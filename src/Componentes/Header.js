    ...
    <header style={{ backgroundColor: "#6a0dad", color: "white", padding: "10px 0" }}>
      <Container fluid className="px-4">
        <Row className="align-items-center">
          <Col md={6} className="text-start" style={{ paddingLeft: "20px" }}>
            <h5 className="mb-1">{InfoHeader.Nombre}</h5>
            <p className="mb-1">
              <FaEnvelope size={14} />{" "}
              <a href={`mailto:${InfoHeader.Email}`} style={{ color: "white", textDecoration: "underline" }}>
                {InfoHeader.Email}
              </a>
            </p>
            <p className="mb-0">
          ...
          <Col md={6}>
            <Nav className="justify-content-end">
              ...
              <Nav.Item>
                <Nav.Link href="#recommendations" style={{ color: "white" }}>Recommendations</Nav.Link>
              </Nav.Item>
            </Nav>
          </Col>
        </Row>
